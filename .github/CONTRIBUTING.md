# Contributing to Akkadu_WebApp

First and foremost, thank you! We appreciate that you want to contribute to Akkadu_WebApp, your time is valuable, and your contributions mean a lot to us.
...
- **version**: (required) please note the version of Akkadu_WebApp are you using
- **error messages**: (required) please paste any error messages into the issue, or a [gist](https://gist.github.com/)
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using

### Closing issues

The original poster or the maintainers of Akkadu_WebApp may close an issue at any time. Typically, but not exclusively, issues are closed when:
