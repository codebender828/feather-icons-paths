...
/** @typedef {{ prefix: 'fe', iconName: 'feMinimize', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherMinimizeIconData */

/** @type {FeatherMinimizeIconData} */
const feMinimize = {
  prefix: 'fe',
  iconName: 'minimize',
  icon: [
