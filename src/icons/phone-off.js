...
/** @typedef {{ prefix: 'fe', iconName: 'fePhoneOff', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherPhoneOffIconData */

/** @type {FeatherPhoneOffIconData} */
const fePhoneOff = {
  prefix: 'fe',
  iconName: 'phone-off',
  icon: [
