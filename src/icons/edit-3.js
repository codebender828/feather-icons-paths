...
/** @typedef {{ prefix: 'fe', iconName: 'feEdit_3', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherEdit_3IconData */

/** @type {FeatherEdit_3IconData} */
const feEdit_3 = {
  prefix: 'fe',
  iconName: 'edit-3',
  icon: [
