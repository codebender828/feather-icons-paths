...
/** @typedef {{ prefix: 'fe', iconName: 'feFacebook', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherFacebookIconData */

/** @type {FeatherFacebookIconData} */
const feFacebook = {
  prefix: 'fe',
  iconName: 'facebook',
  icon: [
