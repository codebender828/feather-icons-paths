...
/** @typedef {{ prefix: 'fe', iconName: 'feCommand', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherCommandIconData */

/** @type {FeatherCommandIconData} */
const feCommand = {
  prefix: 'fe',
  iconName: 'command',
  icon: [
