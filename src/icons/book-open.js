...
/** @typedef {{ prefix: 'fe', iconName: 'feBookOpen', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherBookOpenIconData */

/** @type {FeatherBookOpenIconData} */
const feBookOpen = {
  prefix: 'fe',
  iconName: 'book-open',
  icon: [
