...
/** @typedef {{ prefix: 'fe', iconName: 'feMoon', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherMoonIconData */

/** @type {FeatherMoonIconData} */
const feMoon = {
  prefix: 'fe',
  iconName: 'moon',
  icon: [
