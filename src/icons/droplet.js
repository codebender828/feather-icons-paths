...
/** @typedef {{ prefix: 'fe', iconName: 'feDroplet', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherDropletIconData */

/** @type {FeatherDropletIconData} */
const feDroplet = {
  prefix: 'fe',
  iconName: 'droplet',
  icon: [
