...
/** @typedef {{ prefix: 'fe', iconName: 'feEdit_2', icon: [Number|String, Number|String, import('feather-icons').FeatherAttributes, PathifiedSvgContent, FeatherIconsPathDefinition] }} FeatherEdit_2IconData */

/** @type {FeatherEdit_2IconData} */
const feEdit_2 = {
  prefix: 'fe',
  iconName: 'edit-2',
  icon: [
